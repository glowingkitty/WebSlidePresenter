<script lang="ts">
  ...
  async function handlePDFUpload(event: Event) {
    ...
    try {
      // Reset to welcome screen while loading
      resetPresentation();
...
<div class="min-h-screen bg-gray-900 text-gray-100 p-4">
  {#if $totalSlides === 0}
    ...
    <div class="flex flex-col items-center justify-center min-h-screen">
      <h1 class="text-4xl font-bold mb-4 text-white">🧭 WebSlidePresenter</h1>
      ...
      <div class="col-span-12 space-y-2">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-2">
            <h1 class="text-xl font-bold text-white">🧭 WebSlidePresenter</h1>
          ...
          <div class="flex items-center gap-4">
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="inline-flex items-center gap-1.5 px-3 py-2 text-sm text-gray-400 hover:text-gray-200 transition-colors"
